...
def circuits_p1(junctions, connections = 1000):
...
def circuits_p2(junctions):
    ...
    # print(", ".join([str(len(c)) for c in circuits]))
    # print(len(circuits[0])*len(circuits[1])*len(circuits[2]))
    print(junctions[shortest[0]][0] * junctions[shortest[1]][0])
...
def main():
    ...
    circuits_p1(junctions, 1000)
    circuits_p2(junctions)
